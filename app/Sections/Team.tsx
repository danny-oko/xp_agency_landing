...
export default function Team() {
  return (
    <div className="w-full h-screen rounded-8xl bg-transparent flex flex-col items-center justify-center px-12 py-8 md:py-12">
      <div className="headline w-full h-auto flex flex-col items-center justify-center mb-6 md:mb-8">
        <SplitText
      ...
      <section className="w-full relative flex-1 flex items-center justify-center overflow-y-auto">
        <div className="flex flex-wrap gap-y-6 gap-x-3 w-4/5 mx-auto justify-center items-start py-4">
          {TEAM_MEMBERS.map((member) => (
            <div
              key={member.name}
              className="relative h-64 md:h-72 w-[85%] md:w-[49%] mx-auto md:mx-0 rounded-3xl overflow-hidden border border-white/10 bg-white/5 shadow-[0_-8px_24px_-10px_rgba(255,255,255,0.20),0_16px_32px_-12px_rgba(0,0,0,0.45)] hover:shadow-[0_-10px_28px_-12px_rgba(255,255,255,0.45),0_24px_40px_-12px_rgba(0,0,0,0.6)] transition-shadow"
            >
              <DotGrid
