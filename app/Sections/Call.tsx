      ...
      >
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center gap-8 sm:gap-10 md:gap-12">
          ...
          <button
            ...
            className="relative group bg-gradient-to-r from-xp-violet via-xp-cyan to-xp-teal text-white rounded-full px-6 py-3 md:px-8 md:py-4 lg:px-10 lg:py-5 text-sm md:text-base lg:text-lg font-semibold w-full max-w-[280px] md:max-w-[320px] md:min-w-[280px] lg:min-w-[320px] h-12 md:h-14 lg:h-16 flex items-center justify-center gap-2 md:gap-3 cursor-pointer overflow-hidden transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(168,85,247,0.6),0_0_80px_rgba(56,189,248,0.4)] shadow-[0_0_20px_rgba(168,85,247,0.4),0_0_40px_rgba(56,189,248,0.2)]"
          >
