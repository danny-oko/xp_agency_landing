    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="relative w-full h-[60vh] min-h-[500px] overflow-hidden">
          <Image
            src="https://res.cloudinary.com/dkfnybqnx/image/upload/v1763727110/Screenshot_2025-11-21_at_20.11.43_fzcjyy.png"
            alt="Sengee.mn"
            fill
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pb-12">
              ...
              <p className="text-xl text-gray-300 max-w-2xl">
                Форексийг анхан шатнаас суриа зөв тавин амжилттай арилжаачин
                болох хүртэл бэлдэх онлайн сургалтын платформ.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mb-16">
            ...
            <div className="space-y-4 text-lg text-gray-300 leading-relaxed">
              <p>
                Sengee.mn нь форексийн арилжааг анхан шатнаас эхлээд мэргэжлийн
                түвшинд хүртэл суралцагчдад бэлтгэдэг онлайн сургалтын платформ
                юм. Энэхүү систем нь суралцагчдад форексийн зах зээлийн талаарх
                бүрэн мэдлэг, практик ур чадвар олгох зорилготой бүтээгдсэн.
              </p>
              <p>
                Платформ нь онлайн сургалт, хичээлийн сан, төлбөрийн шийдэл,
                хэрэглэгчийн самбар зэрэг олон функцтэй бөгөөд суралцагчдад
                форексийн арилжааны стратеги, техник шинжилгээ, эрсдэлийн
                удирдлага зэрэг практик мэдлэг, ур чадварыг хөгжүүлэхэд
                тусладаг.
              </p>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                ...
                <p className="text-white text-lg font-semibold">3 долоо хоног</p>
              </div>
              <div className="p-6 bg-white/5 rounded-xl border border-white/10">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="relative aspect-video rounded-xl overflow-hidden border border-white/10">
                <Image
                  src="https://res.cloudinary.com/doxmbmqjm/image/upload/v1763778135/b3ec2e0f-0303-453c-a6fb-997720481267.png"
                  alt="Sengee.mn Screenshot 2"
                  fill
                  className="object-cover"
                  loading="lazy"
                  sizes="(max-width: 768px) 100vw, 50vw"
